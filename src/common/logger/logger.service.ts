...
export class CustomLoggerService implements LoggerService {
  ...
  private createLogger() {
    ...
    const logFormat = winston.format.combine(
      ...
      winston.format.printf(
        ({ timestamp, level, message, context, trace, requestId, userId, ip, userAgent, ...meta }) => {
          const logEntry = {
            timestamp,
    ...
    const consoleFormat = winston.format.combine(
      ...
      winston.format.printf(({ timestamp, level, message, context, requestId }) => {
        ...
        const reqId = typeof requestId === "string" ? `[${requestId.slice(-8)}]` : ""
  ...
  log(message: string, context?: string, meta?: any) {
    this.writeLog("info", message, { context: context || this.context, ...meta })
  }
  ...
  warn(message: string, context?: string, meta?: any) {
    this.writeLog("warn", message, { context: context || this.context, ...meta })
  }

  debug(message: string, context?: string, meta?: any) {
    this.writeLog("debug", message, { context: context || this.context, ...meta })
  }

  verbose(message: string, context?: string, meta?: any) {
    this.writeLog("verbose", message, { context: context || this.context, ...meta })
  }
