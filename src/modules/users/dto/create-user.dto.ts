import { IsEmail, IsNotEmpty, IsString, MaxLength, IsOptional, IsEnum, IsArray } from "class-validator"
...
export class CreateUserDto {
  ...
  @ApiProperty({ example: "+86 138 0013 8000", description: "电话号码", required: false })
  @IsOptional()
  ...
  @ApiProperty({ example: "北京市朝阳区", description: "地址", required: false })
  @IsOptional()
